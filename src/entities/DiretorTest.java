...
public class DiretorTest {
	...
	@Test
	public void addFilmeTest() { // Para testar se adicionou corretamente no ArrayList de filmes que o diretor participou
		assertEquals(1, diretor.mostrarFilmesParticipou().size());
	}
	
	@Test
	public void mostrarFilmesParticipouTest() { // Para testar se o filme correto foi adicionado no ArrayList de filmes
		assertEquals("Universitários", diretor.mostrarFilmesParticipou().get(0).getNome());
	}
